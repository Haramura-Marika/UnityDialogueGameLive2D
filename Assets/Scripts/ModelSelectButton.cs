...
public class ModelSelectButton : MonoBehaviour
{
    ...
    [Header("模型配置")]
    [SerializeField] private int currentProviderIndex = 0; // 0=Minimax, 1=Gemini, 2=DeepSeek, 3=Qwen
    
    // 模型显示名称映射
    private readonly string[] providerNames = { "Minimax", "Gemini", "DeepSeek", "Qwen" };
    ...
    /// 手动设置模型（通过索引）
    /// </summary>
    /// <param name="providerIndex">0=Minimax, 1=Gemini, 2=DeepSeek, 3=Qwen</param>
