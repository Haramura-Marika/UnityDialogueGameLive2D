...
public static class AIService
{
    ...
    public static Task<string> GetAIResponse(List<ChatMessage> chatHistory)
    {
        ...
        {
            case AIModelProvider.Minimax:
                return Minimax_Service.GetAIResponse(chatHistory);
        ...
        CancellationToken ct)
    {
        ...
        {
            case AIModelProvider.Minimax:
                await Minimax_Service.SendStream(null, chatHistory, onDelta, onCompleted, onError, ct);
                break;
            case AIModelProvider.Qwen:
